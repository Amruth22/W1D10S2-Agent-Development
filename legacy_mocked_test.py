"""Legacy Mocked Tests for LangChain AI Research Agent
Tests core components using MOCKED APIs (not real functionality)

WARNING: These are legacy tests with heavy mocking.
For real testing, use: python3 unit_test.py (the smart integration tests)

This file is kept for reference but should not be used for actual testing.
"""
...
if __name__ == "__main__":
    print("⚠️  WARNING: You are running LEGACY MOCKED TESTS")
    print("These tests use heavy mocking and don't test real functionality.")
    print("For real testing, run: python3 unit_test.py")
    print("=" * 60)
    ...
    # Print summary
    print(f"\n{'='*50}")
    print(f"LEGACY MOCKED TEST SUMMARY")
    print(f"⚠️  WARNING: These tests use mocks - NOT real APIs")
    print(f"For real API testing run: python3 unit_test.py")
    print(f"{'='*50}")
